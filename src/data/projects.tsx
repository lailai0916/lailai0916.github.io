...
export const PROJECT_LIST: ProjectItem[] = [
  {
    ...
    status: { text: translate({ id: 'data.project.p1.status', message: 'Under Maintenance' }), color: STATUS_COLORS.ORANGE },
  },
  {
    title: 'iGame',
    ...
    tech: 'C++ • Terminal',
    status: { text: translate({ id: 'data.project.p2.status', message: 'In Development' }), color: STATUS_COLORS.GREEN },
  },
  {
    title: 'laiKit',
    ...
    status: { text: translate({ id: 'data.project.p3.status', message: 'Stay Tuned' }), color: STATUS_COLORS.BLUE },
  },
];
