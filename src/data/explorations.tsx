...
export const EXPLORATION_LIST: ExplorationItem[] = [
  {
    title: translate({ id: 'data.exploration.p1.name', message: 'Algorithm Competitions' }),
    icon: 'lucide:trophy',
    ...
    status: { text: translate({ id: 'data.exploration.p1.progress', message: 'In Progress' }), color: STATUS_COLORS.ORANGE },
  ...
  },
  {
    ...
    status: { text: translate({ id: 'data.exploration.p3.progress', message: 'Exploring' }), color: STATUS_COLORS.BLUE },
