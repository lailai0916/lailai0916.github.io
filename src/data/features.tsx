...
export const FEATURES: FeatureItem[] = [
  {
    ...
    text: <Translate id="data.features.p1.text">The Contest section covers fundamental knowledge, common problem types, solution ideas, code templates, and competition experience related to Olympiad in Informatics. It focuses on real contest environments, emphasizing algorithmic skills, programming practice, and overall competitive ability.</Translate>,
  },
  {
    ...
    text: <Translate id="data.features.p2.text">The Note section organizes learning notes, knowledge summaries, and personal insights across multiple disciplines, including mathematics, programming, technology, and languages. It systematically presents key concepts and practical skills, reflecting the learning and understanding process.</Translate>,
  },
  {
