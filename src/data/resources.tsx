...
export const resourceData: ResourceCategory[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'Gemini', href: 'https://gemini.google.com', description: 'Google多模态AI助手' },
      { name: 'Grok', href: 'https://grok.com', description: 'xAI实时信息AI助手' },
      { name: 'DeepSeek', href: 'https://deepseek.com', description: '深度求索中文AI模型' },
      { name: 'Sora', href: 'https://sora.com', description: 'OpenAI文本生成视频' },
    ],
  },
  {
    name: 'AI 开发研究',
    ...
    resources: [
      ...
      { name: 'Microsoft AI', href: 'https://www.microsoft.com/ai', description: '微软AI研究开发' },
      { name: 'DeepLearning.AI', href: 'https://deeplearning.ai', description: '吴恩达AI教育平台' },
      { name: 'PyTorch', href: 'https://pytorch.org', description: 'Facebook深度学习框架' },
      { name: 'Keras', href: 'https://keras.io', description: '高级神经网络API' },
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'StackBlitz', href: 'https://stackblitz.com', description: '现代前端在线IDE' },
      { name: 'vscode.dev', href: 'https://vscode.dev', description: 'VSCode浏览器版' },
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'MIT OpenCourseWare', href: 'https://ocw.mit.edu', description: 'MIT免费课程资源' },
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'LaTeX 公式编辑器', href: 'https://www.latexlive.com', description: 'LaTeX公式编辑器' },
  ...
  },
  {
    ...
    resources: [
      ...
      { name: '毒蘑菇测试', href: 'https://cznull.github.io/vsbm', description: 'GPU渲染性能测试' },
    ],
  },
  {
    name: '日常工具',
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'Telegram Web', href: 'https://web.telegram.org', description: 'Telegram网页版' },
    ],
  },
  {
    name: '在线游戏',
