...
export const resourceData: ResourceCategory[] = [
  ...
  },
  {
    name: '🔬 AI 开发研究',
    resources: [
      { name: 'Google DeepMind', href: 'https://deepmind.com', description: 'Google AI 研究前沿，推动 AGI 发展', icon: 'https://deepmind.com/favicon.ico' },
      ...
      { name: 'DeepLearning.AI', href: 'https://deeplearning.ai', description: '吴恩达 AI 教育平台，专业课程体系', icon: 'https://deeplearning.ai/favicon.ico' },
      ...
      { name: 'PyCharm', href: 'https://www.jetbrains.com/pycharm', description: 'JetBrains 专业 Python IDE', icon: 'https://www.jetbrains.com/favicon.ico' },
  ...
  },
  {
    name: '💻 开发与编程',
    resources: [
      { name: 'GitHub', href: 'https://github.com', description: '全球最大代码托管平台，开源项目大本营', icon: 'https://github.com/favicon.ico' },
      { name: 'GitLab', href: 'https://gitlab.com', description: '企业级 DevOps 平台，完整开发生命周期', icon: 'https://gitlab.com/favicon.ico' },
      ...
      { name: 'Committers Top', href: 'https://committers.top', description: '各国最活跃 GitHub 用户榜单', icon: 'https://committers.top/favicon.ico' },
      { name: 'GitHub Metrics', href: 'https://github.com/lowlighter/metrics', description: 'GitHub 账号信息图生成器', icon: 'https://github.com/favicon.ico' },
      { name: 'GitHub Stats', href: 'https://github.com/jstrieb/github-stats', description: 'GitHub 个人资料统计图像生成', icon: 'https://github.com/favicon.ico' },
      { name: 'GitHub Profile README Generator', href: 'https://rahuldkjain.github.io/gh-profile-readme-generator', description: '精美 GitHub 个人资料 README 生成', icon: 'https://rahuldkjain.github.io/gh-profile-readme-generator/favicon.ico' },
      { name: 'GitHub Codespaces', href: 'https://github.com/codespaces', description: '云端开发环境，随时随地编程', icon: 'https://github.com/favicon.ico' },
      { name: 'Gitpod', href: 'https://www.gitpod.io', description: '云开发环境，加速软件开发', icon: 'https://www.gitpod.io/favicon.ico' },
      ...
      { name: 'StackBlitz', href: 'https://stackblitz.com', description: '极速在线 IDE，现代前端框架支持', icon: 'https://stackblitz.com/favicon.ico' },
      ...
      { name: '清华大学开源软件镜像站', href: 'https://mirrors.tuna.tsinghua.edu.cn', description: '开源软件包管理器镜像服务', icon: 'https://mirrors.tuna.tsinghua.edu.cn/favicon.ico' },
    ],
  },
  {
    name: '📚 学术研究',
  ...
  },
  {
    name: '🎓 在线学习',
    resources: [
      { name: 'Coursera', href: 'https://www.coursera.org', description: '顶尖大学合作，高质量在线课程', icon: 'https://www.coursera.org/favicon.ico' },
      { name: 'edX', href: 'https://www.edx.org', description: '哈佛 MIT 创立，开放式课程平台', icon: 'https://www.edx.org/favicon.ico' },
      { name: 'MIT OpenCourseWare', href: 'https://ocw.mit.edu', description: 'MIT 免费课程资源，知识无界限', icon: 'https://ocw.mit.edu/favicon.ico' },
      { name: 'Class Central', href: 'https://www.classcentral.com', description: '全球课程搜索比较，学习路径规划', icon: 'https://www.classcentral.com/favicon.ico' },
    ],
  },
  {
    name: '🏆 编程竞赛',
    resources: [
      { name: 'Codeforces', href: 'https://codeforces.com', description: '全球最受欢迎编程竞赛平台', icon: 'https://codeforces.com/favicon.ico' },
  ...
  },
  {
    name: '📖 静态站点生成',
    resources: [
      { name: 'VitePress', href: 'https://vitepress.vuejs.org', description: '基于 Vite 和 Vue 的现代静态网站生成器', icon: 'https://vitepress.vuejs.org/favicon.ico' },
      { name: 'VuePress', href: 'https://vuepress.vuejs.org', description: 'Vue 驱动的静态网站生成器，专注文档', icon: 'https://vuepress.vuejs.org/favicon.ico' },
      { name: 'Docusaurus', href: 'https://docusaurus.io', description: 'Facebook 开源文档网站构建工具', icon: 'https://docusaurus.io/favicon.ico' },
      { name: 'Hexo', href: 'https://hexo.io', description: '快速简洁高效的博客框架', icon: 'https://hexo.io/favicon.ico' },
      { name: 'WordPress', href: 'https://wordpress.org', description: '全球最受欢迎开源内容管理系统', icon: 'https://wordpress.org/favicon.ico' },
    ],
  },
  {
    name: '🔧 开发工具',
    resources: [
      ...
      { name: '毒蘑菇测试', href: 'https://cznull.github.io/vsbm', description: 'GPU 图形渲染性能基准测试', icon: 'https://cznull.github.io/favicon.ico' },
    ],
  },
  {
    name: '🛠️ 日常工具',
    resources: [
      ...
      { name: '政治倾向测试', href: 'https://luckyfuy.top/compass/', description: '基于 8Values 的政治倾向分析', icon: 'https://luckyfuy.top/favicon.ico' },
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'cppreference', href: 'https://cppreference.com', description: 'C++ 标准库权威参考文档', icon: 'https://cppreference.com/favicon.ico' },
  ...
  },
  {
    name: '☁️ 云服务平台',
    resources: [
      { name: 'Amazon Web Services', href: 'https://aws.amazon.com', description: '全球领先云计算平台，服务全面', icon: 'https://aws.amazon.com/favicon.ico' },
  ...
  },
  {
    ...
    resources: [
      ...
      { name: 'Skill Icons', href: 'https://skillicons.dev', description: '开发者技能图标生成工具', icon: 'https://skillicons.dev/favicon.ico' },
      { name: 'BrandColors', href: 'https://brandcolors.net', description: '品牌官方配色方案收集', icon: 'https://brandcolors.net/favicon.ico' },
  ...
  },
  {
    name: '📱 社交网络',
    resources: [
      { name: 'X (Twitter)', href: 'https://x.com', description: '全球实时信息社交网络平台', icon: 'https://x.com/favicon.ico' },
      { name: 'Facebook', href: 'https://www.facebook.com', description: '全球最大社交网络平台', icon: 'https://www.facebook.com/favicon.ico' },
  ...
  },
  {
    name: '🔓 网络工具',
    resources: [
      { name: '墙妈妈', href: 'https://www.wallmama.com', description: '科学上网指南网络自由访问', icon: 'https://www.wallmama.com/favicon.ico' },
