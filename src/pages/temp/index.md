...
杭州中考的 **招生录取** 规则中有个 **分配生政策**。

对于大部分目标为 **普通高中** 的考生，需要在中考前填写：

- $5$ 个 **名额分配生** 志愿；
- $10$ 个 **统一招生** 志愿。

**分配生** 是各高中将部分（重高 $70\%$，优高 $40\%$）招生名额 **按初中人数比例** 分配到各初中，根据中考成绩的 **校内排名** 进行录取；而 **统一招生** 就是根据 **全市排名** 进行录取。
