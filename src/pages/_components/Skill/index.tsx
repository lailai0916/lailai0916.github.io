    ...
    <BaseCard isClickable={false} className="p-6 items-center justify-center">
      <div className="flex flex-col items-center text-center space-y-4">
        <div className="flex justify-center items-center h-12 w-12">
          <IconWrapper>
            <img src={`https://skillicons.dev/icons?i=${icon}&theme=light#gh-light-mode-only`} alt={title} className="w-12 h-12 object-contain" />
            <img src={`https://skillicons.dev/icons?i=${icon}&theme=dark#gh-dark-mode-only`} alt={title} className="w-12 h-12 object-contain" />
          </IconWrapper>
        </div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col px-5">
        <SectionHeader
          ...
          description={translate({
            ...
            message: 'Building technical skills is a continuous journey — every skill is a practical tool for solving problems.',
          })}
        />
