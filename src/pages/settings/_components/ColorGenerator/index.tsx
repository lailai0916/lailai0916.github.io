      ...
      <div className="card__body">
        ...
        <div className="margin-bottom--md">
          <div className="margin-bottom--sm">
            <label htmlFor="primary_color" className="margin-bottom--xs" style={{ display: 'block', fontWeight: 'bold' }}>
              主色调值：
            </label>
        ...
        {/* 颜色预览 */}
        <div className="margin-bottom--md">
          <label className="margin-bottom--xs" style={{ display: 'block', fontWeight: 'bold' }}>
            色阶预览：
          </label>
          <div
            ...
            {colors.map((color) => (
              <button
                ...
                style={{
                  ...
                  border: baseColor === color ? '3px solid var(--ifm-color-primary)' : '2px solid var(--ifm-color-emphasis-300)',
                  cursor: 'pointer',
