    ...
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row px-5">
      <div className="max-w-3xl lg:max-w-7xl gap-5 flex flex-col lg:flex-row lg:px-5">
        ...
        <div className="w-full lg:w-6/12 max-w-3xl flex flex-col items-start justify-start lg:ps-5 lg:pe-10">
          ...
          <h1 className="font-bold text-4xl lg:text-5xl text-gray-900 dark:text-neutral-100 leading-tight mb-4">{PAGE_CONFIG.title}</h1>
          <p className="text-lg lg:text-xl text-gray-700 dark:text-neutral-300 leading-relaxed mb-6">{PAGE_CONFIG.description}</p>
        </div>
...
const TravelTimeline = React.memo(() => (
  <Section background="alt">
    <div className="max-w-7xl mx-auto flex flex-col px-5">
      <SectionHeader title="旅行足迹" description="纸上得来终觉浅，绝知此事要躬行" />
