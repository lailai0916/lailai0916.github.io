...
const sidebars: SidebarsConfig = {
  contestSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        'contest/graph/flow',
        'contest/graph/graph-matching/graph-match',
  ...
  noteSidebar: [
    ...
    },
    {
      ...
      items: [
        'note/physics/motion-force',
        'note/physics/energy-momentum',
        'note/physics/gravitation',
        'note/physics/electricity',
        'note/physics/electromagnetism',
        'note/physics/wave-optics',
        'note/physics/thermology',
        'note/physics/modern-physics',
      ],
    },
    {
      type: 'category',
      ...
      items: [
        'note/chemistry/fundamentals',
        'note/chemistry/inorganic',
        'note/chemistry/structure',
        'note/chemistry/reaction',
        'note/chemistry/solution-electrochemistry',
