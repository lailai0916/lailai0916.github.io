...
const sidebars: SidebarsConfig = {
  sidebar1: [
    'contest/index',
    {
      ...
      items: ['contest/personal/code-style', 'contest/personal/code-checker', 'contest/personal/common-templates', 'contest/personal/problem-transfer'],
    },
    {
      type: 'category',
      label: '比赛相关',
    ...
    },
    {
      ...
      items: [
        'contest/math/binary-exponentiation',
        {
          ...
          items: ['contest/math/number-theory/prime', 'contest/math/number-theory/gcd', 'contest/math/number-theory/sqrt-decomposition', 'contest/math/number-theory/euler-totient', 'contest/math/number-theory/sieve', 'contest/math/number-theory/inverse', 'contest/math/number-theory/du'],
        },
        {
          type: 'category',
          label: '组合数学',
          ...
          items: ['contest/math/combinatorics/permutation-and-combination', 'contest/math/combinatorics/inclusion-exclusion-principle'],
        },
        {
          type: 'category',
          label: '多项式与生成函数',
        ...
        },
        {
          ...
          items: ['contest/math/numerical/interp', 'contest/math/numerical/integral', 'contest/math/numerical/elimination'],
        },
        {
          type: 'category',
          label: '杂项',
    ...
    },
    {
      ...
      items: ['contest/ds/dsu', 'contest/ds/heap', 'contest/ds/block', 'contest/ds/monotonous-stack', 'contest/ds/sparse-table', 'contest/ds/fenwick', 'contest/ds/seg', 'contest/ds/bst', 'contest/ds/persistent-seg'],
    },
    {
      type: 'category',
      label: '图论',
      ...
      items: [
        ...
        'contest/graph/flow',
        {
          ...
          items: ['contest/graph/tree/diameter', 'contest/graph/tree/lca', 'contest/graph/tree/difference', 'contest/graph/tree/hld', 'contest/graph/tree/virtual-tree'],
        },
        {
          type: 'category',
          label: '连通性',
    ...
    },
    {
      ...
      items: ['contest/geometry/2d', 'contest/geometry/3d', 'contest/geometry/convex-hull', 'contest/geometry/scanning', 'contest/geometry/rotating-calipers', 'contest/geometry/geometry-templates'],
    },
    {
      type: 'category',
      label: '杂项',
          ...
          items: [
            {
              ...
              items: ['note/math/high-school/misc/set-and-logic', 'note/math/high-school/misc/inequality', 'note/math/high-school/misc/vector', 'note/math/high-school/misc/complex', 'note/math/high-school/misc/permutation-and-combination', 'note/math/high-school/misc/binomial'],
            },
            {
              type: 'category',
              label: '函数',
              ...
              items: ['note/math/high-school/function/function', 'note/math/high-school/function/trigonometric-function/index', 'note/math/high-school/function/sequence', 'note/math/high-school/function/derivative'],
            },
            {
              type: 'category',
              label: '集合',
              ...
              items: ['note/math/high-school/geometry/triangle-solving/index', 'note/math/high-school/geometry/solid-geometry', 'note/math/high-school/geometry/conic'],
            },
            {
              type: 'category',
              label: '概率',
              ...
              items: ['note/math/high-school/probability/statistics', 'note/math/high-school/probability/probability', 'note/math/high-school/probability/distribution'],
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              items: ['note/math/advanced/linear-algebra/行列式的性质与计算', 'note/math/advanced/linear-algebra/行列式的展开', 'note/math/advanced/linear-algebra/矩阵', 'note/math/advanced/linear-algebra/万能的初等行变换', 'note/math/advanced/linear-algebra/向量', 'note/math/advanced/linear-algebra/解方程组', 'note/math/advanced/linear-algebra/特征值、特征向量、对角化', 'note/math/advanced/linear-algebra/二次型'],
            },
            {
              type: 'category',
              label: '《概率论与数理统计》',
          ...
          items: [
            {
              ...
              items: ['note/english/grammar/verbs/verb-classification', 'note/english/grammar/verbs/verb-tenses', 'note/english/grammar/verbs/verb-moods', 'note/english/grammar/verbs/non-finite-verbs', 'note/english/grammar/verbs/auxiliary-modal-verbs', 'note/english/grammar/verbs/linking-verbs', 'note/english/grammar/verbs/causative-verbs'],
            },
            {
              type: 'category',
              label: '词性',
              ...
              items: ['note/english/grammar/parts-of-speech/nouns', 'note/english/grammar/parts-of-speech/articles', 'note/english/grammar/parts-of-speech/pronouns', 'note/english/grammar/parts-of-speech/adjectives', 'note/english/grammar/parts-of-speech/numerals', 'note/english/grammar/parts-of-speech/adverbs', 'note/english/grammar/parts-of-speech/prepositions', 'note/english/grammar/parts-of-speech/conjunctions', 'note/english/grammar/parts-of-speech/interjections'],
            },
            {
              type: 'category',
              label: '句子',
              ...
              items: ['note/english/grammar/sentences/sentence-types', 'note/english/grammar/sentences/clauses', 'note/english/grammar/sentences/absolute-constructions', 'note/english/grammar/sentences/subject-verb-agreement', 'note/english/grammar/sentences/passive-voice', 'note/english/grammar/sentences/inversion', 'note/english/grammar/sentences/emphasis', 'note/english/grammar/sentences/ellipsis'],
            },
            {
              type: 'category',
              label: '其他',
              ...
              items: ['note/english/grammar/miscellaneous/word-formation', 'note/english/grammar/miscellaneous/punctuation'],
            },
          ],
        },
      ],
