...
这五个点的位置关系直接决定了最终曲线的类型。例如，如果五个点构成一个凸五边形，那么它们确定的曲线必然是椭圆。如果一个点“远离”其他四个点，则很可能形成双曲线或抛物线。
...
我们不妨设 $F_1=(-c,0),F_2=(c,0)$ 为焦点的椭圆经过点 $M$，且 $M$ 到 $F_1,F_2$ 的局里之和为 $2a$，其中 $a>c$，那么写出方程：
