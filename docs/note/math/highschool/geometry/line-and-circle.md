...
常见的直线方程有 **斜截式、两点式、点斜式、截距式、一般式、点向式和参数式** 等。
...
因此只要 $D^2+E^2>4F$，该方程就可以表示一个圆了；特殊地，如果 $D=E=F$ 则该方程表示一个点 $(0,0)$。具体的，圆心：$\left(-\frac{D}{2},-\frac{E}{2}\right)$，半径：$\frac{\sqrt{D^2+E^2-4F}}{2}$。
