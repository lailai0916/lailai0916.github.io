...
- [不等式 - 维基百科](https://zh.wikipedia.org/wiki/不等式)
...
「基本不等式」这个术语有些歧义，但在《人教版高中数学 · 必修一》中，将上述不等式称为基本不等式，它实际是下文中均值不等式的一个特例。
...
详见 [《与均值有关的定积分函数》](/blog/math/average-integral)。
