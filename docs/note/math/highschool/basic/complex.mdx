...
数集在前面的 [集合](/docs/note/math/highschool/basic/set#数集) 章节中提到过，我们在实数集 $\mathbb{R}$ 的基础上扩展出 **复数集** $\mathbb{C}$。
...
我们将 [向量](/docs/note/math/highschool/basic/vector) $\overrightarrow{OZ}$ 的 **模长** 定义为复数 $z=a+bi$ 的 **模长**，记为：
...
这类似于任意角 [三角函数](/docs/note/math/highschool/function/trigonometric) 的定义。
...
从 **极坐标系** 转换到 **直角坐标系** 可以使用 [三角函数](/docs/note/math/highschool/function/trigonometric)：
