...
生活中食品包装袋上写着 $230\mathrm{g}\pm 10\%$，表示近似值介于 $207\mathrm{g}$ 和 $253\mathrm{g}$ 之间。
...
**正负号** $\pm$ 也可以配合 **负正号** $\mp$ 使用，需要注意符号上下的对应顺序。例如：
...
带符号有一个明显的优势：可以直接代入公式，自动处理方向和性质，简化计算与判断，避免繁琐的过程。

其实这个思想在初中就有了，例如「如果向东走 $20$ 米记作 $+20$，那么向西走 $30$ 米可以记作什么？」的选择题。
