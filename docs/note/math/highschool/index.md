...
我的高中数学大部分是在初中自学的，当时只是感兴趣。高中数学教材中的定义虽然非常严谨，但也晦涩难懂，不易理解。通过网上的课程和视频，从不同角度理解问题，这对我帮助很大。

在学习研究的过程中，我积累了很多独特的思考和体会。写下这份笔记是为了整理自己的理解，希望能对你有所帮助。我尽量写得深入浅出，如有不明之处，欢迎找我交流。

<Notation>**祝你好运！**</Notation>

## 说明

高中课本为避免混淆，会使用句点（`．`）代替句号（`。`），详见 [知乎问题](https://www.zhihu.com/question/29663496)。

本文包含较多的 **数学公式** 和 **交互组件**，建议在电脑上查看，手机上可能显示异常，且不建议打印。
