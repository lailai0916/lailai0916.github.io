...
\begin{aligned}
  ...
  & =\frac{a^2}{2}\left(t+\frac{\sin 2t}{2}\right)+C=\frac{a^2}{2}\arcsin\frac xa+\frac{x\sqrt{a^2-x^2}}{2}+C
\end{aligned}
$$
...
$$
2I=\int_0^{\pi/2}\frac{\sin x+\cos x}{\sin x+\cos x}\mathrm{d}x=\int_0^{\pi/2}1\mathrm{d}x=\frac\pi2\implies I=\frac\pi4
$$
