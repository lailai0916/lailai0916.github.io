...
|A-\lambda E|=\begin{vmatrix}
  ...
  -1 & 2-\lambda & -1 \\
  0 & -1 & 2-\lambda
\end{vmatrix}=(2-\lambda)\big[(2-\lambda)^2-1\big]-(-1)\big[-(2-\lambda)\big]
$$
...
$$
Q=\begin{pmatrix}
  \frac{1}{\sqrt3} & -\frac{1}{\sqrt2} & -\frac{1}{\sqrt6} \\[2pt]
  \frac{1}{\sqrt3} & \frac{1}{\sqrt2} & -\frac{1}{\sqrt6} \\[2pt]
  \frac{1}{\sqrt3} & 0 & \frac{2}{\sqrt6}
\end{pmatrix},\qquad Q^TAQ=\begin{pmatrix}
  5 &  &  \\
  & -1 &  \\
  &  & -1
\end{pmatrix}
