...
1. 单音节形容词及部分双音节：直接在词尾加 -er（比较级）或 -est（最高级）。
...
- 一般以 -le, -ow, -er 或 -y 结尾的双音节形容词发音轻，结构简单，通常用 -er / -est；而结构复杂的通常用 more / most。
- 有些双音节词两种形式都可接受（polite $\to$ politer / more polite $\to$ politest / most polite，但 more polite 更常用）。
