...
**连接代词**（Conjunctive Pronoun）引导 **名词性从句**（主语从句、宾语从句、表语从句、同位语从句），且 **在从句中充当成分**（详见 [从句](../sentences/clauses)）。
...
**关系代词**（Relative Pronoun）引导 **定语从句**，**代替先行词** 并 **在从句中充当成分**（详见 [从句](../sentences/clauses)）。
