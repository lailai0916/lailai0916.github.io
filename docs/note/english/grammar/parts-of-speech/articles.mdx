---
title: 冠词
description: 本文讲解英语不定冠词、定冠词与零冠词的用法及各类易混规则。
summary: 英语冠词的系统笔记。冠词分不定冠词 a/an、定冠词 the 与零冠词三类。不定冠词用于单数可数名词表泛指，a 与 an 的选择取决于后接单词的首音而非首字母，归纳首次提及、表每一、表职业等用法。定冠词表特指或独一无二，梳理再次提及、被限定语修饰、最高级序数词、乐器名与专有名词加不加 the 的规则。零冠词用于泛指复数、抽象与物质名词、专有名词及三餐球类学科、交通方式等固定搭配，并对比 school 与 the school 的语义差别。
---
