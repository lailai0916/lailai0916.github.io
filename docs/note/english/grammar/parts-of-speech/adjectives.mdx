---
title: 形容词
description: 本文讲解英语形容词的语义分类、位置、多词排序、句法功能与比较级最高级。
summary: 英语形容词的系统笔记。先按语义分性质、描述、限定、数量四类，说明只有性质与部分描述形容词可比较。位置上区分前置定语、后置定语、表语与宾语补足语。多个形容词连用按 OSASCOMP（美小新圆色国材用）排序。梳理形容词充当定语、表语、补足语、状语的句法功能，以及加 the 表一类人、抽象概念、国民总称的用法。最后讲比较级与最高级的构成规则、不规则变化与常见比较句型。
---
