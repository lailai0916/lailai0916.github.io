---
title: 非谓语动词
description: 本文讲解英语不定式、动名词、现在分词、过去分词四种非谓语动词的用法与辨析
summary: 非谓语动词是动词的非谓语形式，不能单独作谓语，却保留及物性与时态语态，含不定式、动名词、现在分词、过去分词四种。不定式由 to 加原形构成，另有裸不定式，可作主语、宾语、表语、宾补、定语、状语，并有进行式、完成式与被动形式。动名词作名词用，辨析 remember、forget、stop、try、mean、go on 等后接不定式与动名词的意义差别。现在分词表主动或进行，过去分词表被动或完成，二者作定语、表语、状语、宾补，并区分 -ing 与 -ed 形容词。末尾讲独立主格及 to do、doing 的固定搭配。
---
