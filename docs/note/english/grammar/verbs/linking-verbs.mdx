---
title: 系动词
description: 本文讲解英语系动词的五类划分、表语搭配及易错点。
summary: 系动词连接主语和表语，本身意义不完整，须与表语共同作谓语；表语可为名词、形容词、代词、数词、介词短语、非谓语动词或从句。按语义分五类：状态系动词 be，持续系动词 keep、remain、stay、continue，变化系动词 become、get、grow、turn、go、come、fall、run，表象系动词 seem、appear、look，感官系动词 look、sound、smell、taste、feel，并辨析 go 多接负面、come 多接正面等搭配差异。易错点强调系动词后接形容词而非副词、同一动词作实义与系动词的区分、系动词无被动语态。
---
