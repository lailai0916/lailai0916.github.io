---
title: 动词时态
description: 本文讲解英语由时间与状态组合成的十六种时态的构成、用法与时间标志词
summary: 时态把时间与状态两个正交维度组合起来：时间有现在、过去、将来、过去将来四种，状态有一般、进行、完成、完成进行四种，相乘得十六种时态。以说话时刻 t0 为原点建立时间坐标系定位动作，用关注事实、过程、结果还是持续来选择状态。正文逐一给出十六种时态的构成形式与核心用法并配标志词，如现在完成的 since、for、so far，过去进行的 when、while。末尾归纳「先定位后描述」的二步法则、主从句时态呼应规律，以及各时态的时间标志词系统。
---
...
以现在 $t_0$ 为原点，三个时区沿时间轴排列：

$$
\overset{\text{过去}}{t<t_0}\longleftarrow\overset{\text{现在}}{t_0}\longrightarrow\overset{\text{将来}}{t>t_0}
$$

过去将来是过去某时点 $t_1$（$t_1<t_0$）视角下的相对将来。
...
|   状态类型   |                      例句                       |     语义重点      |
| :----------: | :---------------------------------------------: | :---------------: |
|   **一般**   |          I do homework.（我做作业。）           |  做作业这个事实   |
|   **进行**   |     I am doing homework.（我正在做作业。）      | 正在做作业的过程  |
|   **完成**   |     I have done homework.（我已做完作业。）     | 做作业的经历/影响 |
| **完成进行** | I have been doing homework.（我一直在做作业。） | 持续做作业的过程  |
...
- 固定计划 → The train leaves at 8 p.m.
...
- 将来安排 → We are meeting at 3 p.m. tomorrow.
...
- 将来时刻进行 → I will be sleeping at 11 p.m. tonight.
...
- 到将来某时完成 → I will have finished my homework by 8 p.m.
...
- 过去看将来进行 → He said he would be working in the garden at 3 p.m.
...
| 主句时态 | 从句时态范围 |                               示例                                |
| :------: | :----------: | :---------------------------------------------------------------: |
|  现在时  |   任意时态   |       I think he is/was/will be right.（我认为他是对的。）        |
|  过去时  |  过去时态系  | I thought he was/had been/would be right.（我当时认为他是对的。） |
