---
title: 省略
description: 本文讲解英语省略的前提条件，按句型分述各类成分的省略规则与易错点。
summary: 省略指为避免重复省去句中可补出的成分，前提是能从上下文准确还原且不改变语义，在口语、对话、并列句、比较句中尤为常见。按句型分述：祈使句省主语 you，对话应答省主语、助动词、系动词，并列句省相同的主语、谓语、宾语，状语从句在主从主语一致时省主语加 be，定语从句关系代词作宾语可省，宾语从句省 that，不定式省 do 仅留 to。特殊结构包括比较句、感叹句、so / not 替代宾语从句、if any 与 if ever。易错点强调省略须能唯一还原，两分句主语不同时主语不可省。
---
