---
title: 主谓一致
description: 本文讲解英语主谓一致的语法、意义、就近三条原则及各类特殊结构。
summary: 主谓一致指谓语在人称和数上与主语相符，遵循语法一致、意义一致、就近一致三条原则。语法一致讲单复数对应、and 连接的并列主语及其表同一人或整体概念、each every 修饰等例外、不定代词、集合名词。意义一致讲时间距离金额视为整体用单数、书名剧名用单数、算术运算用单数，以及 news、学科名、国名、疾病名等形复实单，people、police 及 the rich 等形单实复，还有成对名词。就近一致讲 either...or、neither...nor、not only...but also 及 there be。特殊结构补充 as well as、定语从句先行词、what 从句作主语。
---
