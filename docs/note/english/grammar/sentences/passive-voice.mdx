---
title: 被动
description: 本文讲解英语被动语态的构成、各时态与句型的转换、主动转被动步骤及易错点
summary: 被动语态把主动句的宾语提前作主语，谓语的 do 改为 be done，只有及物动词才有被动。梳理各时态的被动形式，对照五种基本句型说明单及物、双及物、复杂及物的转换，不及物与连系动词无被动。给出主动转被动的四步：宾变主、谓改 be 加过去分词并保留原时态、状语不动、原主语移到 by 之后。另讲情态动词加 be done、非谓语的被动形式，以及不用被动的情形，如状态动词 have / fit / cost、反身代词作宾语。易错点覆盖主动形式表被动、get-passive、动作与状态被动的区别。
---
...
- This dress **fits** her well.（这条裙子很适合她。）✓
- ~~She is fitted by this dress well.~~ ✗
- The book **cost** me 50 yuan.（这本书花了我 50 元。）✓
...
| 类别                              |                                        示例                                         |
| :-------------------------------- | :---------------------------------------------------------------------------------: |
| 系动词 + 形容词                   |                   The cake **tastes** good.（这蛋糕尝起来不错。）                   |
| need / want / require + doing     |      The window **needs cleaning**.（窗户需要擦了。）_(= needs to be cleaned)_      |
| 主语 + 不及物动词 + well / easily |                 This book **sells well**.（这本书很畅销。）_(畅销)_                 |
| be + to do（主动表被动）          | The work **is to be done** today.（这项工作今天要完成。）_(也可用 be to do 表被动)_ |
...
- He **got hurt** in the accident.（他在事故中受了伤。）_(强调动作)_
- He **was hurt** in the accident.（他在事故中受了伤。）_(可强调状态)_
...
- The window **was broken** by him.（窗户是被他打破的。）_(动作被动)_
- The window **is broken**.（窗户是坏的。）_(状态被动，说明窗户现在是坏的)_
...
- The **books** **were** written by him.（这些书是他写的。）_(主语复数，be 复数)_
- The **book** **was** written by him.（这本书是他写的。）_(主语单数，be 单数)_
