---
title: 倒装
description: 本文讲解英语完全倒装与部分倒装的各种适用情形及易错点。
summary: 倒装是把谓语或谓语的一部分提到主语之前，分完全倒装与部分倒装两类。完全倒装用于地点方位副词提前的 here comes 型、there be 句型、表语提前。部分倒装用于疑问句，否定副词 never、hardly、no sooner、not until 置于句首，only 加状语提前，so / neither / nor 表示「也（不）」，虚拟条件句省 if 后 were、had、should 提前，so 或 such ... that 提前，as 或 though 引导让步，句首 may 表祝愿，以及频率副词提前。易错点讲倒装后主谓一致，并与强调结构区分。
---
