...
- **It** is well-known **that he is honest**. _(更常用)_
...
- The man **that** I spoke **with** is my uncle. _(介词后置，可用 that)_
...
按语义可分为 $9$ 类，引导词详见 [连词](../parts-of-speech/conjunctions)。
...
**as if / as though** 可用 **虚拟语气**（详见 [动词语气](../verbs/verb-moods)）。
