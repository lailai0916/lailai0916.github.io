...
平均速度：一段路程的变化（$\Delta s$）和路程的变化（$\Delta t$）之比，即 ${\color{Orange}{V=\dfrac{\Delta s}{\Delta t}}}$.

瞬时速度：瞬间路程的变化（$\Delta s$）和路程的变化（$\Delta t$）之比，此时 ${\color{Orange}{\Delta t \to 0}}$，即 ${\color{Orange}{V=\displaystyle\lim_{\Delta t \to 0}\dfrac{\Delta s}{\Delta t}}}$.
