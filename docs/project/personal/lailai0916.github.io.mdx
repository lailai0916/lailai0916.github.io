...
域名我也纠结了很久。其实我在 2021 年 5 月 25 日就注册了 `lailai0916.com`，但总觉得有点长，一直想要 `lailai.com`。可惜这个域名是美国一家「莱莱食府」的官网，我想花几百美元买下来，但中介说对方已经拒绝过 1 万美元了。后来我又考虑过 `lailai.one`、`lailai.top`、`lailai.cc`、`lailai.io`、`lailai.ai` 等，最后在 2024 年 10 月 16 日选定并注册了 `lailai.one`。
