...
域名我也纠结了很久。其实我很早就买下了 `lailai0916.com`，但总觉得有点长，一直想要 `lailai.com`。可惜这个域名是美国一家「莱莱食府」的官网，我想花钱买下来，但中介说对方拒绝过 1 万美元，实在太贵了。后来我又考虑过 `lailai.one`、`lailai.top`、`lailai.cc`、`lailai.io` 等，最后选定了 `lailai.one`。
