...
2025 年 **杭州中考** 分为 **文化课考试** 和 **体育考试**。文化课考试是全省统考；体育考试每个市县项目和分值有所不同。

社会分为 **开卷** 和 **闭卷** 两个版本。

共有语文、数学、英语、科学、社会和体育 $6$ 个科目，满分 $650$ 分。
...
杭州中考体育考试共有 **两轮考试**，如果 **第一轮** 未获满分，可以继续参加 **第二轮**。

考试共 $30$ 分，分为 $3$ 个类别各 $10$ 分，每个类别都可从 $2$ 个选项中任选 $1$ 项。
...
有关中考难度的争议，可以看看这篇知乎帖子：https://www.zhihu.com/question/1921292276602243030
