---
title: 洛谷贡献
description: 本文为 lailai 的洛谷贡献记录，围绕咕值系统讲题解与搬题，并附模板、工具与翻译提示词。
summary: 记录我在洛谷平台的贡献，围绕咕值系统的社区贡献指标展开：题解占 70 分、搬题占 30 分，搬运一道主题库题目得 1 分永久咕值。给出题解写作模板与 P1001 示例，附上搬题所需的 testlib Special Judge 校验器和评测配置文件生成器。搬题记录列出从 NOISG 搬运的 30 道题与 CCF CSPro 的 20 道题，配一张 NOISG 逐年搬运情况表。文末收录用于 AI 翻译整理英文题面、辅助专栏审核题解的两段提示词。
---
