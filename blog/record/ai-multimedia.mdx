...
全球最大的代码托管平台，开源模型、工具、各种 Awesome 清单都在上面，很多 AI 项目第一手的代码和文档也是先发 GitHub，我自己的项目也都放在这里。

- [GitHub](https://github.com)

### Hugging Face

开源模型的大本营，模型、数据集、在线演示 Spaces 都能找到，想跑开源模型基本绕不开它。
...
AI 检测工具，测一段文本有多大概率是 AI 写的。前面说的「降 AI 率」就是拿它来回测，改到分数够低再交。
