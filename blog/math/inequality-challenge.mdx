---
title: 数学：不等式挑战（一）
description: 本文将介绍一个不等式闯关，在 a 平方加 b 平方等于 1 下逐关求七个式子的最大值。
summary: 已知实数 a、b 满足 a 平方加 b 平方等于 1，逐关求 ab、a+b、a+3b 一直到 (a+1)(b+2) 等七个式子的最大值。前几关靠均值不等式、配方与柯西式的拆项配凑即可解决，最后一关是钓鱼题，需动用拉格朗日乘数法与三次方程求根公式暴力求出约 4.68 的最大值。
date: 2025-01-14T05:07:00+08:00
authors: lailai
tags: [math]
---
