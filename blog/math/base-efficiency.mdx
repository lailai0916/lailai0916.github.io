---
title: 数学：进制效率
description: 本文将介绍进制效率的计算，说明为何理论上 e 进制最优，而工程上 3 进制效率最高。
summary: 用 x 进制表示整数 n，所需位数约为以 x 为底 n 的对数，每一位有 x 种状态，总状态数正比于 x 除以 ln x。该函数在 x 等于 e 时取最小值，因此理论上 e 进制效率最高。但 e 进制在工程上无法实现，而 2 进制与 4 进制效率相同，3 又比 4 更接近 e，所以实际中 3 进制效率最高。
