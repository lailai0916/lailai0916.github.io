---
title: 数学：2025 年浙江中考数学第 24 题解析
description: 本文将介绍 2025 年浙江中考数学压轴第 24 题的解析，用建系法求 PA 减 PB 的最小值。
summary: 2025 年浙江中考数学压轴第 24 题的解析。题目在菱形 ABCD 中通过轴对称构造点 F、P，求 PA 减 PB 的最小值。这里用建系法：设好坐标，算出对称点 F 与交点 P，把 PA 减 PB 写成关于参数 t 的函数再求导，解出临界点后代回，得到最小值为 3 倍根号 39 减 4 再除以 5，约等于 2.947。
