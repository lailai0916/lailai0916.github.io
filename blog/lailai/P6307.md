...
![三角形框](https://cdn.luogu.com.cn/upload/image_hosting/bqqdb2l4.png)
...
int main()
{
	...
	double v1=(1.0-sqrt(17))/2+m;
	double v2=(1.0+sqrt(17))/2+m;
	double ans=(digamma(v1)-digamma(v2))*(-2)/sqrt(17);
	int cnt=0;
