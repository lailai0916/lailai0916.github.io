---
title: '题解：P8074 [COCI 2009/2010 #7] SVEMIR'
description: 本文为洛谷 P8074 的题解，三维分别排序保留相邻点的边，在候选边上跑 Kruskal 求生成树。
summary: 三维空间给定 n 个点，任意两点的边权取三维坐标差绝对值的最小值，求最小生成树。完全图有 n 方条边无法直接建。关键观察：对 x、y、z 三维分别排序后，每维只保留相邻点之间的边，共 3(n-1) 条候选边就足以包含某棵最小生成树的全部边，由最小生成树的切割性质可证。在这些候选边上跑 Kruskal 即可，时间复杂度 O(nlogn)。
date: 2025-10-07T10:18:23+08:00
authors: lailai
