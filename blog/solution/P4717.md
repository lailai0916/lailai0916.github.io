...
- [(1 封私信 / 61 条消息) FWT(快速沃尔什变换)零基础详解qaq（ACM/OI） - 月下桃子树 - 知乎](https://zhuanlan.zhihu.com/p/41867199)
...
综上，我们可以通过分治写出 $\operatorname{xor}$ 的递归版本：
...
同理，我们可以通过倍增写出 $\operatorname{xor}$ 更高效（常数更小）的迭代版本：
...
| :--------: | :---------------------------: | :----------------------------: | :------------------------------: | :-------------------------------: |
|  分治递归  |      $665.67_{+15.71\%}$      |      $693.12_{+23.84\%}$       |       $1167.31_{+24.31\%}$       |       $1164.39_{+24.25\%}$        |
|  倍增迭代  |           $575.31$            |            $559.65$            |             $939.02$             |             $937.16$              |
| 高维前缀和 |      $966.18_{+67.94\%}$      |      $961.38_{+71.78\%}$       |                -                 |                 -                 |
