...
综上，我们可用分治写出 $\operatorname{or}$ 和 $\operatorname{and}$ 的递归版本：
...
类似 FFT，我们可用倍增写出 $\operatorname{or}$ 和 $\operatorname{and}$ 的更高效（常数更小）的迭代版本：
...
综上，我们可用分治写出 $\operatorname{xor}$ 和 $\operatorname{xnor}$ 的递归版本：
...
同理，我们可用倍增写出 $\operatorname{xor}$ 和 $\operatorname{xnor}$ 更高效（常数更小）的迭代版本：
