...
description: 本文为洛谷 CF1468G 的题解，从后往前维护斜率最小的遮挡点，对每条线段求交并累加受照长度。
summary: 光源位于末端点正上方 h 处，折线由 n 个点顺次相连，求折线上能被光源直接照到的总长度。某点可见当且仅当光源到它的连线不被其他点遮挡，即其对光源的斜率不小于之前所有点。从后往前维护当前斜率最小的点，对每条线段分类讨论：左端点被遮挡则整段不可见；否则求线段与遮挡光线的交点，交点上方部分可见；两端点对光源斜率相等时整段可见。累加各段可见长度即为答案。
date: 2024-12-23T00:46:58+08:00
authors: lailai
