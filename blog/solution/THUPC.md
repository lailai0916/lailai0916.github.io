...
- [[THUPC 2025 初赛] 摊位分配](https://thupc2025.preliminary-round.thusaac.com/contest/1/problem/4)
...
显然，对于每个 $u_i$，其 $n_i \sim \log u_i$，因此总的操作次数为 $O(\sum \log u_i)$，即时间复杂度为 $O(T \log u_i)$。
