...
注意到 $n,m\le 100$，可以分别 $O(n^2)$ 枚举每个子矩形的左上角 $(x_1,y_1)$ 和右下角 $(x_2,y_2)$。
...
\begin{cases}
  ...
  \sum_{i=x_1}^{x_2}\sum_{j=y_1}^{y_2}p_{i,j}=a_{x_2,y_2}-a_{x_1-1,y_2}-a_{x_2,y_1-1}+a_{x_1-1,y_1-1} \\
  S_{(x_1,y_1)\to(x_2,y_2)}=(x_2-x_1+1)(y_2-y_1+1)
\end{cases}
$$
