---
title: 题解：P15421 像你这样的朋友
description: 本文为洛谷 P15421 的题解，按坐标和除以 3 的余数分三个集合，任填一个集合即可拿到基础分。
summary: 在 n 乘 n 的 01 网格里尽量多填 1，要求任取一个 1 上下左右移动一步后都不出现横向或纵向连续三个 1，填 n 方除以 3 上取整个可拿基础分。做法是按 (i+j) 除以 3 的余数把格子分成三个集合，同一集合内连续三格至多一个 1，任填一个集合都合法，由鸽巢原理最大集合的大小恰为 n 方除以 3 上取整。代码直接打表输出各 n 的构造。
date: 2026-03-05T13:00:35+08:00
authors: lailai
