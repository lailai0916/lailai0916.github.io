...
summary: 给定长度为 n 、由点号和小写字母构成的字符串，每次修改一个字符，并询问把所有连续点号缩成单个点号所需的替换次数。该次数等于点号总数减去连续点号段数。维护这两个量，每次修改仅影响被改位置与其左右相邻字符的关系，分类讨论字母与点号互换如何增减段数与总数，即可在常数时间内更新每次询问的答案。
date: 2024-12-24T01:16:43+08:00
authors: lailai
