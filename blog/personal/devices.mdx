---
title: 个人：设备
description: 本文分享 lailai 的个人数码设备清单与使用体会，几乎全套 Apple 生态并附桌面布局。
summary: lailai 的个人数码设备清单与使用体会，几乎全套 Apple 生态。逐台记录 MacBook Pro（M3 Max）、iPad Pro（M1）、iPhone 13、Apple Watch Series 10、AirPods Pro 2、AirPods Max 与 Powerbeats Pro 2 的配置、配件与激活时间，谈了买 Mac 与钛金属手表的取舍理由，并附 Dock、Launchpad、主屏幕、菜单栏等桌面布局细节。
...
我买过很多配件，但最后感觉还是裸机最舒服：MacBook Pro 的铝合金外壳容易变形，所以我配了一个保护壳，但不优雅就扔了；我也试过贴屏幕膜和键盘膜，但 B 面（屏幕）和 C 面（键盘）间隙很小，键盘会印在屏幕上，最后也放弃了；我还给 140W 电源适配器配了一个收纳壳。
...
我没有电话手表，平时学校里不能带手机，而且我喜欢体育锻炼，所以考虑买了一块 Apple Watch。

我本来想和同学一样买 Ultra 2 的，但它对我来说有点大，戴在手上不协调，额外功能也主要面向极限运动。当时 Series 10 刚发布不久，又赶上 Apple Watch 三年一换的新模具，最后选择了钛金属版的 Series 10。钛金属版（95% 再生钛、蓝宝石水晶玻璃）和铝金属版（100% 再生铝、Ion-X 强化玻璃）只有表壳和屏幕的材质不同，价格却几乎贵了一倍，甚至比 Ultra 2 还贵，虽然毫无性价比，但是真的优雅。

表带我选择了石板色米兰尼斯，这是一款不锈钢编织表带，质感与钛金属表壳一致。它同时具备了优雅、舒适、透气、便捷、防水、耐用等几乎所有优点。唯一的问题是无极磁吸设计在网球等长时间剧烈运动后会逐渐变松，每几分钟就需要调整一次，所以我又买了一根黑色单圈表带。虽然质感不如米兰尼斯，但也挺舒适的，外观比较简洁。戴了一周后我发现硅胶过敏，换成了深灰色回环式运动表带。
