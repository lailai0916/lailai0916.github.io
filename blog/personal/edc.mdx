---
title: 个人：EDC
description: 本文分享 lailai 日常外出的随身物品清单，涵盖收纳、数码、生活与文教用品。
summary: lailai 日常外出随身携带的物品清单，分收纳、数码、生活用品、文教用品几类。收纳含背包与腰包；数码以充电器、数据线、固态 U 盘、AirTag 为主；文教用品列出常用的笔、橡皮、圆规、计算器与电子辞典等具体型号。
date: 2025-04-23T17:08:00+08:00
authors: lailai
tags: [personal]
---
...
- 设备：详见 [lailai's Devices](/blog/personal/devices)。
...
- Apple Park Black Ballpoint Pen
